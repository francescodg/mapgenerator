...
**
** Created: Wed May 21 22:04:28 2014
...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        mapArea->setGeometry(QRect(9, 9, 551, 331));
        mapArea->setMinimumSize(QSize(0, 138));
        layoutWidget = new QWidget(Form);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 360, 551, 95));
        gridLayout = new QGridLayout(layoutWidget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        initialDispl_txt = new QLineEdit(layoutWidget);
        initialDispl_txt->setObjectName(QString::fromUtf8("initialDispl_txt"));

        gridLayout->addWidget(initialDispl_txt, 2, 1, 1, 1);
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        initialDispl_txt->setText(QApplication::translate("Form", "20", 0, QApplication::UnicodeUTF8));
        ...
        label_3->setText(QApplication::translate("Form", "Initial displacement", 0, QApplication::UnicodeUTF8));
